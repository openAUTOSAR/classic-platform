...
CC_EXTENSION  struct EDMA_tag {
		...
		int8_t EDMA_reserved5;		/* JRichard 26MAR2007 */

        union {
            //vuint32_t R;			/* JRichard 26MAR2007 */
			vuint16_t R;
            struct {
                //vuint32_t:16;		/* JRichard 26MAR2007 changed all bits to vuint16's */
                vuint16_t ERQ15:1;
                vuint16_t ERQ14:1;
                vuint16_t ERQ13:1;
                vuint16_t ERQ12:1;
		...
		int8_t EDMA_reserved6;		/* JRichard 26MAR2007 */
		...
		int8_t EDMA_reserved7;		/* JRichard 26MAR2007 */
		...
		int8_t EDMA_reserved8;		/* JRichard 26MAR2007 */
...
/*                          MODULE : FlexCAN                                */
/****************************************************************************/
CC_EXTENSION     struct FLEXCAN_tag {
        union {
            vuint32_t R;
            struct {
                vuint32_t MDIS:1;
        ...
        //} CTRL;                 /* Control Register */		/* JRichard */
...
/*              vuint32_t BUF9I:1;
                ...
                vuint32_t BUF2I:1;
                vuint32_t BUF1I:1;
                vuint32_t BUF0I:1;	// JRichard changed per mpc5554.h BUF0-->BUF00 etc.
*/            } B;
...
#define SEMA4     (*( struct SEMA4_tag *)     0xFFF14000)
