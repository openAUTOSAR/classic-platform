...
#define SCHM_MAINFUNCTION_CYCLE_COM     SCHM_CYCLE_MAIN
 ...
 * Schedule BSW memory
 */
#define SCHM_CYCLE_MEM				20

#define SCHM_MAINFUNCTION_CYCLE_NVM     SCHM_CYCLE_MEM
#define SCHM_MAINFUNCTION_CYCLE_FEE     SCHM_CYCLE_MEM
#define SCHM_MAINFUNCTION_CYCLE_FLS     SCHM_CYCLE_MEM
