...
DECLARE_STACK(bTask10,PRIO_STACK_SIZE);
...
// The vector table
void * IntCtrl_VectorTable[NUMBER_OF_INTERRUPTS_AND_EXCEPTIONS] __attribute__ ((aligned (0x0800),section(".data")))= {
};
