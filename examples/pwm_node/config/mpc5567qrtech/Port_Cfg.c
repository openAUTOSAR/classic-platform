...
const uint16_t PortPadConfigData[] = {
	...
	( PORT_FUNC1 | PORT_OBE_ENABLE | PORT_SLEW_RATE_MIN | PORT_PULL_NONE ),	/* PCR	189 : PORT_PIN_MODE_PWM */
	PORT_PCR_RESET,			/* PCR	190 */
	( PORT_FUNC1 | PORT_OBE_ENABLE | PORT_SLEW_RATE_MIN | PORT_PULL_NONE ),	/* PCR	191 : PORT_PIN_MODE_PWM */
