...
typedef enum
{
	WDGM_TRIGGER_INSTANCE0,
	WDGM_TRIGGER_INSTANCE1,
	WDGM_NBR_OF_TRIGGERS,
}WdgM_TriggerIdType;
...
typedef struct
{
	...
	const Gpt_ChannelType            WdgM_GptChannelRef; // TODO type??
...
typedef struct
{
	...
	const WdgM_TriggerType            WdgM_Trigger[WDGM_NBR_OF_TRIGGERS];
}WdgM_ModeConfigType;
