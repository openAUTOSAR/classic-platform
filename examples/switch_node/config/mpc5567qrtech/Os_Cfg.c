...
// ##################################    ALARMS     ################################
GEN_ALARM_AUTOSTART(ALARM_ID_ComAlarm, ALARM_AUTOSTART_RELATIVE, 5, 20, OSDEFAULTAPPMODE );
	
GEN_ALARM_AUTOSTART(ALARM_ID_ReadSwAlarm, ALARM_AUTOSTART_RELATIVE, 10, 30, OSDEFAULTAPPMODE );
