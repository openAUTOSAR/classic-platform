...
extern void switch_node_switches_callback (void);
extern void switch_node_potentiometers_callback (void);
 ...
 * The switches
 */
const Adc_ChannelType Adc_Group0ChannelList[ADC_NBR_OF_SWITCH_CHANNELS] =
{
  ADC_CH11, ADC_CH12
};
 ...
 * The potentiometers
 */
const Adc_ChannelType Adc_Group1ChannelList[ADC_NBR_OF_POTENTIOMETER_CHANNELS] =
{
    ADC_CH8, ADC_CH9, ADC_CH10
};
...
const Adc_GroupDefType AdcGroupConfiguration [] =
{
   { .accessMode        = ADC_ACCESS_MODE_SINGLE, .conversionMode = ADC_CONV_MODE_ONESHOT,
     ...
     .groupCallback     = switch_node_switches_callback,
   ...
   { .accessMode        = ADC_ACCESS_MODE_SINGLE, .conversionMode = ADC_CONV_MODE_ONESHOT,
     .triggerSrc        = ADC_TRIGG_SRC_SW, .hwTriggerSignal = ADC_NO_HW_TRIG,
     .hwTriggerTimer    = ADC_NO_TIMER,
     .groupCallback     = switch_node_potentiometers_callback,
     .streamBufferMode  = ADC_NO_STREAMING, .streamNumSamples = 0,
