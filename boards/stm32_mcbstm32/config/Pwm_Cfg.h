 ...
 */
/*
 * PWM003: The detection of development errors is configurable (STD_ON/STD_OFF) at
 ...
 *
 * Note: Currently only STD_ON mode is supported.
 */
#define PWM_DUTYCYCLE_UPDATED_ENDPERIOD STD_ON

/*
 * Setting to STD_ON freezes the current output state of a PWM channel when in
 * debug mode.
 */
