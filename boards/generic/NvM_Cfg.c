 ...
 */
Std_ReturnType SingleBlockFunctionCallback1(uint8 ServiceId, NvM_RequestResultType JobResult)
{
	return E_OK;
}
...
const NvM_BlockDescriptorType BlockDescriptorList[] = {
	{
		...
		.SingleBlockCallback = SingleBlockFunctionCallback1,
		.NvBlockLength = 4,
