...
{
  {
    ...
    .GptChannelId = GPT_CHANNEL_PIT_4,
    .GptChannelMode = GPT_MODE_ONESHOT,
    .GptChannelClkSrc = 0,
    .GptNotification = NULL,
    .GptChannelPrescale = 0,
    ...
    .GptChannelId = GPT_CHANNEL_PIT_5,
    .GptChannelMode = GPT_MODE_CONTINUOUS,
    .GptChannelClkSrc = 0,
    .GptNotification = NULL,
    .GptChannelPrescale = 0,
    ...
    .GptChannelId = GPT_CHANNEL_PIT_6,
    .GptChannelMode = GPT_MODE_ONESHOT,
    .GptChannelClkSrc = 0,
    .GptNotification = NULL,
    .GptChannelPrescale = 0,
    ...
    .GptChannelId = GPT_CHANNEL_PIT_7,
    .GptChannelMode = GPT_MODE_CONTINUOUS,
    .GptChannelClkSrc = 0,
    .GptNotification = NULL,
    .GptChannelPrescale = 0,
    ...
    .GptChannelId = GPT_CHANNEL_PIT_8,
    .GptChannelMode = GPT_MODE_ONESHOT,
    .GptChannelClkSrc = 0,
    .GptNotification = NULL,
    .GptChannelPrescale = 0,
