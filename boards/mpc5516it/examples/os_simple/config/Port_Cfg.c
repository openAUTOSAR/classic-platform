...
const uint16_t PortPadConfigData[] = {
	...
	( PORT_FUNC1 | PORT_OBE_ENABLE | PORT_SLEW_RATE_MAX | PORT_PULL_NONE ),	/* PCR	61 : PORT_PIN_MODE_SPI */
	( PORT_FUNC1 | PORT_OBE_ENABLE | PORT_SLEW_RATE_MAX | PORT_PULL_NONE ),	/* PCR	62 : PORT_PIN_MODE_SPI */
	( PORT_FUNC1 | PORT_IBE_ENABLE | PORT_SLEW_RATE_MIN | PORT_PULL_NONE ),	/* PCR	63 : PORT_PIN_MODE_SPI */
	( PORT_FUNC1 | PORT_OBE_ENABLE | PORT_SLEW_RATE_MIN | PORT_PULL_NONE ),	/* PCR	64 : PORT_PIN_MODE_SPI */
	( PORT_FUNC1 | PORT_OBE_ENABLE | PORT_SLEW_RATE_MIN | PORT_PULL_NONE ),	/* PCR	65 : PORT_PIN_MODE_SPI */
	PORT_PCR_RESET,			/* PCR	66 */
	( PORT_FUNC1 | PORT_OBE_ENABLE | PORT_SLEW_RATE_MAX | PORT_PULL_NONE ),	/* PCR	67 : PORT_PIN_MODE_SPI */
	( PORT_FUNC1 | PORT_OBE_ENABLE | PORT_SLEW_RATE_MAX | PORT_PULL_NONE ),	/* PCR	68 : PORT_PIN_MODE_SPI */
	( PORT_FUNC1 | PORT_IBE_ENABLE | PORT_SLEW_RATE_MIN | PORT_PULL_NONE ),	/* PCR	69 : PORT_PIN_MODE_SPI */
