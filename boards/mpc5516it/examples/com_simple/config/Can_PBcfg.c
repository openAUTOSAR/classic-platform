...
{  
  {
    ...
    .CanControllerSeg1 =		4,
    .CanControllerSeg2 =		4,
    .Can_Arc_Flags =			(CAN_CTRL_BUSOFF_PROCESSING_INTERRUPT | CAN_CTRL_RX_PROCESSING_INTERRUPT | CAN_CTRL_TX_PROCESSING_INTERRUPT | CAN_CTRL_WAKEUP_PROCESSING_INTERRUPT | CAN_CTRL_ACTIVATION | CAN_CTRL_FIFO),
