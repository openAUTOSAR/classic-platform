...
#define CANIF_PDU_ID_RxPdu1		0
#define CANIF_PDU_ID_RxPdu2		1

#define CANIF_PDU_ID_TxPdu1		0
#define CANIF_PDU_ID_TxPdu2		1
...
#define CANIF_CONTROLLER_ID_Controller_A	CANIF_Channel_1
