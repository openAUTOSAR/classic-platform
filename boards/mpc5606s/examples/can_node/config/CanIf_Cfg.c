...
*           on Tue May 10 13:36:20 CEST 2011
*/
...
const CanIf_TxPduConfigType CanIfTxPduConfigData[] = {	
  {
    .CanIfTxPduId = PDUR_SOURCE_PDU_ID_TxPdu1,
    .CanIfCanTxPduIdCanId = 513,
  ...
  {
    .CanIfTxPduId = PDUR_SOURCE_PDU_ID_TxPdu2,
    .CanIfCanTxPduIdCanId = 514,
    .CanIfCanTxPduIdDlc = 8,
    .CanIfCanTxPduType = CANIF_PDU_TYPE_STATIC,
#if ( CANIF_READTXPDU_NOTIFY_STATUS_API == STD_ON )
    .CanIfReadTxPduNotifyStatus = false, 
...
const CanIf_RxPduConfigType CanIfRxPduConfigData[] = {		
  {
    .CanIfCanRxPduId = PDUR_DEST_PDU_ID_RxPdu1,
    .CanIfCanRxPduCanId = 257,
    .CanIfCanRxPduDlc = 8,
  ...
  {
    .CanIfCanRxPduId = PDUR_DEST_PDU_ID_RxPdu2,
    .CanIfCanRxPduCanId = 258,
    .CanIfCanRxPduDlc = 8,
#if ( CANIF_CANPDUID_READDATA_API == STD_ON )    
    .CanIfReadRxPduData = false,
#endif    
