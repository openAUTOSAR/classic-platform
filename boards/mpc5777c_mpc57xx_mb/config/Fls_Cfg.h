...
#define FLS_FLASH_WRITE_BUFFER_SIZE 256   /* Page buffer size for C55 flash*/
#define FLASH_MAX_SECTORS			40

#define FLS_TOTAL_SIZE              0x01000000 /*last sector address*//* This is used to indicate total size including the reserved areas */
