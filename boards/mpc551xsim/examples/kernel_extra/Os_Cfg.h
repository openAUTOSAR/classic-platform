...
*           on Tue May 24 22:44:40 CEST 2011
*/
...
#define OSTICKDURATION			1000000    // Time between ticks in nano seconds
...
#define OS_TICKS2SEC_Counter1(_ticks)		( (OSTICKDURATION * _ticks * OSTICKSPERBASE_Counter1)/1000000000UL )
#define OS_TICKS2MS_Counter1(_ticks)		( (OSTICKDURATION * _ticks * OSTICKSPERBASE_Counter1)/1000000UL )
#define OS_TICKS2US_Counter1(_ticks)		( (OSTICKDURATION * _ticks * OSTICKSPERBASE_Counter1)/1000UL )
#define OS_TICKS2NS_Counter1(_ticks)		(OSTICKDURATION * _ticks * OSTICKSPERBASE_Counter1)
...
// Isr Id's
#define ISR_ID_LossOfClock	0
#define ISR_ID_LossOfLock	1
#define ISR_ID_TickTrigg	2

// Resource Id's
#define RES_ID_Resource1	0

// Linked resource id's

// Resource masks
#define RES_MASK_Resource1	(1 << 0)
...
#define OS_ISR_CNT			3
#define OS_ISR2_CNT 		1
#define OS_ISR1_CNT			2
